...
function getStyles(props, context, state) {
  ...
  const hovered = ((state.isKeyboardFocused || state.hovered) &&
    !state.rightIconButtonHovered &&
    !state.rightIconButtonKeyboardFocused) || active;
  const styles = {
    root: {
      backgroundColor: hovered ? hoverColor : null,
      ...
      borderLeft: hovered ? "1px solid" : "1px solid " + muiTheme.drawer.background,
    },
    ...
    innerDiv: {
      ...
      paddingLeft: leftIcon || leftAvatar || leftCheckbox || insetChildren ? 52 : 16,
      paddingRight: rightIcon || rightAvatar || rightIconButton ? 56 : rightToggle ? 72 : 16,
      paddingBottom: singleAvatar ? 15 : 11,
      paddingTop: singleNoAvatar || threeLine ? 11 : 15,
      position: 'relative',
    },
    ...
    hoveredColor: muiTheme.palette.secondaryTextColor, 
  };
...
/**
 * 1. Add active props,
 * 2. Decrease left icon size,
 * 3. Decrease the margin between left icon and text
 */
class ListItem extends Component {
  ...
  static propTypes = {
    /**
     * If true, it's show active styles
     */
...
const hovered = this.props.active || ((state.isKeyboardFocused || state.hovered) &&
  !state.rightIconButtonHovered &&
  !state.rightIconButtonKeyboardFocused);

if (leftIcon) {
  const additionalProps = {
    color: hovered ? leftIcon.props.hoverColor || styles.hoveredColor : leftIcon.props.color || this.context.muiTheme.listItem.leftIconColor,
  };
  this.pushElement(
    contentChildren,
    leftIcon,
...
if (rightIcon) {
  const additionalProps = {
    color: hovered ? rightIcon.props.hoverColor || styles.hoveredColor : rightIcon.props.color || this.context.muiTheme.listItem.rightIconColor
  };
  this.pushElement(
    contentChildren,
    rightIcon,
